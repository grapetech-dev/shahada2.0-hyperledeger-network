...
async function main() {
	try {
		...
		const caClient = buildCAClient(FabricCAServices, ccp, 'ca.SU.shahada.ae');
		...
		try {
			...
			let result = await contract.submitTransaction('putinIMplicitSNM', 'sid', 'yelslow', '5', 'Tom', '1300');
